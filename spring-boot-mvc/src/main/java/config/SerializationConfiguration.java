...
public class SerializationConfiguration
{
	 ...
	 *
	 * @param jsonMapper instance of object mapper for JSON.
	 * @return instance of message converter for JSON.
	 */
	@Bean(name = "mappingJackson2HttpMessageConverter")
	public MappingJackson2HttpMessageConverter mappingJackson2HttpMessageConverter(final @Autowired @Qualifier(value = "jsonMapper") ObjectMapper jsonMapper)
	{
	 ...
	 *
	 * @param xmlMapper instance of object mapper for XML.
	 * @return instance of message converter for XML.
	 */
	@Bean("mappingJackson2XmlHttpMessageConverter")
	public MappingJackson2XmlHttpMessageConverter mappingJackson2XmlHttpMessageConverter(final @Autowired @Qualifier(value = "xmlMapper") XmlMapper xmlMapper)
	{
